...
namespace _3.PL.Views
{
    public partial class FrmHoaDon : Form
    {
        ...
        private void LoadData()
        {
            ...
            foreach (var x in _qHoaDonService.GetAll())
            {
                dgridGioHang.Rows.Add(stt++, x.HoaDon.Id, x.HoaDon.Ma, x.HoaDon.NgayTao, x.HoaDon.NgayThanhToan, x.HoaDon.DiaChi, x.HoaDon.Sdt, (x.HoaDon.TinhTrang == 1 ? "Hoạt động" : "Không hoạt động"));
            }
        }
